...
of elements, and the selection is returned as a data frame---but there is one exception If you select a single column
...
As with matrices, R is oddly specific (in a slightly different way) about the kinds of size discrepancies it will
